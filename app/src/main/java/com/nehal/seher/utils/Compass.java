...
public class Compass implements SensorEventListener {
    ...
    private void dialogError(final Context context) {
        ...
        builder.setTitle(context.getString(com.nehal.seher.R.string.dialog_title));
        builder.setCancelable(false);
        builder.setIcon(android.R.drawable.ic_dialog_alert);
        builder.setMessage(context.getString(com.nehal.seher.R.string.dialog_message_sensor_not_exist));
